...
def insert_course():
	...
	new_coach_2 = Coach.objects.create(
							...
							gender='M',
							phone='(050) 847-73-38',
							address='ул. Садовая, дом 76, квартира 156',
							skype='user_2',
							description='Руководитель группы разработки веб-проектов 2')
	new_coach_3 = Coach.objects.create(
							user=new_user_3,
							date_of_birth='1985-11-28',
							gender='M',
							phone='(050) 847-73-39',
							address='ул. Садовая, дом 77, квартира 156',
							skype='user_3',
							description='Руководитель группы разработки веб-проектов3')
	...
	new_course_1 = Course.objects.create(
							name='JavaSkript',
							short_description='Практический курс2',
							description='Практический курс2 по изучению современного языка программирования Java.',
							coach=new_coach_1,
							assistant=new_coach_2)

	new_course_1 = Course.objects.create(
							name='Ruby',
							short_description='Практический курс3',
							description='Практический курс3 по изучению современного языка программирования Ruby.',
							coach=new_coach_3,
							assistant=new_coach_2)
