...
class StudentsListTest(TestCase):
    ...
    def test_student_lists(self):
        student1 = Student.objects.create(name="Ivan",date_of_birth = '2015-01-01')
    ...
    def test_create_content(self):
        ...
        self.assertContains(responce, 'Ivan')
...
class StudentsDetailTest(TestCase):
    ...
    def test_student_date_of_birth(self):
        client = Client()
        student1 = Student.objects.create(name="Ivan",date_of_birth = '1990-09-10')
        response = client.get('/students/1/')
