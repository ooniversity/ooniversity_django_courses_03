    ...
    if request.GET:
        ...
        if form.is_valid():
          ...
          if d < 0:
            ...
            message = "Дискриминант равен нулю, квадратное уравнение имеет один действительный корень: x1 = x2 = {0}".format(x) 
          else:
            x1 = round((-b + d**(1/2.0)) / 2*a, 1)
            x2 = round((-b - d**(1/2.0)) / 2*a, 1)
            message = "Квадратное уравнение имеет два действительных корня: x1 = {0}, x2 = {1}".format(x1,x2)
